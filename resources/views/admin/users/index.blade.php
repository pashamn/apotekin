...
@section('content')
    ...
    <div class="mb-8">
        <div class="flex justify-between items-center">
            <h1 class="text-2xl font-semibold text-gray-800">Manajemen Data</h1>
    ...
    <div class="bg-white rounded-lg shadow-sm">
        <div class="p-6 border-b">
            <h3 class="text-lg font-semibold">Daftar Data</h3>
        </div>
                ...
                <table class="min-w-full divide-y divide-gray-200">
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        <tr>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">Contoh Nama 1</td>
                            <td class="px-6 py-4 text-sm text-gray-500">Ini adalah keterangan contoh pertama</td>
                        ...
                        <tr class="bg-gray-50">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">Contoh Nama 2</td>
                            <td class="px-6 py-4 text-sm text-gray-500">Ini adalah keterangan contoh kedua</td>
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">2024-01-06</td>
                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium space-x-2">
                                <button class="text-blue-500 hover:text-blue-700" title="Lihat Detail">
                                    <i class="fas fa-eye"></i>
                        ...
                        <tr>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">Contoh Nama 3</td>
                            <td class="px-6 py-4 text-sm text-gray-500">Ini adalah keterangan contoh ketiga</td>
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">2024-01-06</td>
                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium space-x-2">
                                <button class="text-blue-500 hover:text-blue-700" title="Lihat Detail">
                                    <i class="fas fa-eye"></i>
